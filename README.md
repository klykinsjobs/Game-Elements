...
- See the in-game guide for information about all the various game features

## License
Game Elements is licensed under the MIT license. See the LICENSE file for details.
